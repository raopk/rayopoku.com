...
lib.ssMetadata = [
		{name:"Pendulum_new_1_HTML5 Canvas_atlas_1", frames: [[0,0,133,523],[135,204,39,66],[177,68,38,66],[135,0,40,66],[176,204,39,66],[177,136,38,66],[135,68,40,66],[177,0,39,66],[135,272,38,66],[135,136,40,66]]}
];
...
(lib.CachedBmp_10 = function() {
	this.initialize(ss["Pendulum_new_1_HTML5 Canvas_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Pendulum_new_1_HTML5Canvas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: '50B02BF44210814FBECCD5F3EB3A96C0',
	width: 1280,
	height: 720,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Pendulum_new_1_HTML5 Canvas_atlas_1.png?1637762376873", id:"Pendulum_new_1_HTML5 Canvas_atlas_1"},
		{src:"sounds/AUDIO_3031wav.mp3?1637762376948", id:"AUDIO_3031wav"}
	],
	preloads: []
};
...
an.compositions['50B02BF44210814FBECCD5F3EB3A96C0'] = {
